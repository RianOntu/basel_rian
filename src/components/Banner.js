    ...
    <div className="w-full  mx-auto mt-[3px]">
      ...
      >
        <SwiperSlide>
          ...
          <div className="absolute top-[90px] inset-0 flex items-center justify-center ">
            <h1 className="text-black text-sm md:3xl font font-semibold w-[300px] md:w-full ">
              Everything 40% Disound On Handbags,Clothes and All Girl Items
            </h1>
          </div>
          <div className="absolute top-[200px] inset-0 flex items-center justify-start ">
        ...
        <SwiperSlide>
          ...
          <div className="absolute top-[90px] inset-0 flex items-center justify-start ">
            <h1 className="text-black text-sm md:3xl font font-semibold w-[300px] md:w-full ">
              Everything 40% Disound On Handbags,Clothes and All Girl Items
            </h1>
          </div>

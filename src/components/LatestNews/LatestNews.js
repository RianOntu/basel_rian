    ...
    <>
      <div className="w-[80%] mx-auto mt-[50px] mb-[30px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16 mt-5 max-w-[1056px] mx-auto">
          {[ "blog12-1-1024x629",
            "slider-hero-1-1024x539",
            "blog-new-1-1024x629",
            "blog-new-17-1024x629",
            "blog-image-9-1-1024x629",
            "blog-new-photo-1-1024x629"].map((img, index) => (
            <div key={index} className="flex flex-col overflow-hidden relative group">
              <div className="relative overflow-hidden">
                <img
                  ...
                  src={`https://new-basel2.myshopify.com/cdn/shop/articles/${img}_900x.jpg`}
                  alt=""
                />
                ...
                <div className="absolute bottom-0 left-[40%] text-white text-sm bg-cyan-300 p-1 px-3">Hobbie</div>
              ...
              <div className="text-center">
                ...
                <p className="mt-3 text-justify text-sm">
                  Ut cubilia metus sagittis rhoncus non suspendisse vestibulum a taciti posuere urna scelerisque neque scelerisque condimentum sed hac sem
                </p>
              </div>
            </div>
          ))}
